from layers import *
from fastlayers.fast_layers import conv_forward_fast, conv_backward_fast, max_pool_forward_fast, max_pool_backward_fast
...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
  ...
  followed by a batch normalization and then ReLU
  created by zcy
  """
...
def conv_bn_relu_pool_forward(x, w, b, gamma, beta, conv_param, bn_param, pool_param):
  ...
  """
  a, conv_cache = conv_forward_fast(x, w, b, conv_param)
  n, bn_cache = spatial_batchnorm_forward(a, gamma, beta, bn_param) # bn
